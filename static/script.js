    ...
    btnDownload.addEventListener('click', async () => {
        ...
        try {
            ...
            if (!contentType || !contentType.includes("application/json")) {
                ...
                throw new Error("Server Error: The downloader requires a local Python environment and cannot run on Vercel's serverless platform. Please run the project locally.");
            }
